...
//const unsigned char code Heavy_rainbmp PROGMEM []= { //Keil
//const rom unsigned char Heavy_rainbmp PROGMEM []= { //Microchip C18
//const unsigned char Heavy_rainbmp PROGMEM []= { //SDCC
