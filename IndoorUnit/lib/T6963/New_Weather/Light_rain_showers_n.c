...
//const unsigned char code Light_rain_showers_nbmp PROGMEM []= { //Keil
//const rom unsigned char Light_rain_showers_nbmp PROGMEM []= { //Microchip C18
//const unsigned char Light_rain_showers_nbmp PROGMEM []= { //SDCC
