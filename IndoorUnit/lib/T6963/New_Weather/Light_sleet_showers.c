...
//const unsigned char code Light_sleet_showersbmp PROGMEM []= { //Keil
//const rom unsigned char Light_sleet_showersbmp PROGMEM []= { //Microchip C18
//const unsigned char Light_sleet_showersbmp PROGMEM []= { //SDCC
