...
//const unsigned char code Clear_skybmp PROGMEM []= { //Keil
//const rom unsigned char Clear_skybmp PROGMEM []= { //Microchip C18
//const unsigned char Clear_skybmp PROGMEM []= { //SDCC
